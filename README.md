...
The [watch.json](https://glitch.com/help/restart/) file in this project configures Glitch to use optimal `install` and `restart` rules for developing React apps. 